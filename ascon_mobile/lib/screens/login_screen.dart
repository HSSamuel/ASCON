...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Replaced semi-transparent background with pure White (or Dark Mode surface)
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            ...
            // ✅ Removed the glassmorphism Container decoration entirely
            child: Padding(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      filled: true, 
                      // ✅ Set to solid subtle grey so it stands out against pure white
